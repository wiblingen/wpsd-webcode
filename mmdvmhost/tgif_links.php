...
if (empty($dmrID) == false) {
    ...
    if (isset($session_nr)) {
        ...
        <table>
	      ...
	      echo '<tr>'."\n";
          echo '  <td align="left" style="padding: 8px;white-space:normal; word-wrap:break; width:200px;">tgif.network<br /><small>(<a href="http://tgif.network/selfcare.html" target="_blank">Your HotSpot/Repeater ID: '.$repeaterid.'</a>)</small></td>';
