...
function listDAPNETGWMessages($logLinesDAPNETGateway, $tillMYRIC) {
	...
	echo "  <td class=\"text-center\" style=\"width: 70px; vertical-align: top;\">Slot ".$pocsag_timeslot."</td>\n";
	echo "  <td class=\"text-center\" style=\"width: 90px; vertical-align: top;\">".$pocsag_ric."</td>\n";
...
?>
    ...
    <div class="table-header-bar">
      <div class="table-title">Personal Messages</div>
    </div>
    
    <div class="modern-table-container">
		<table class="modern-table poc-lh-table">
		    <thead>
			<tr>
...
<div id='pocsag-sec'>
    <div class="table-header-bar">
      <div class="table-title"><?php echo __( 'DAPNET Activity' );?></div>
    </div>
	...
	<div class="modern-table-container">
		...
		<thead>
		    <tr>
			<th style="width: 140px;" ><a class="tooltip" href="#"><?php echo __( 'Time' );?> (<?php echo date('T')?>)<span><b>Time in <?php echo date('T')?> time zone</b></span></a></th>
			<th class="text-center" style="width: 70px;" ><a class="tooltip" href="#"><?php echo __( 'Time Slot' );?><span><b>Message Mode</b></span></a></th>
			<th class="text-center" style="width: 90px;" ><a class="tooltip" href="#"><?php echo __( 'Target' );?><span><b>RIC / CapCode of the receiving Pager</b></span></a></th>
			<th style="width: max-content;" ><a class="tooltip" href="#"><?php echo __( 'Message' );?><span><b>Message contents</b></span></a></th>
		    </tr>
		</thead>
		<tbody>
